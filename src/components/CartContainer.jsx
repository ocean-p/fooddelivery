      ...
      <div className='w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col'>
        ...
        <div className='w-full h-340 md:h-42 px-6 py-10 flex flex-col gap-3
          ...
          <div className='w-full p-1 px-2 rounded-lg bg-cartItem flex items-center
            gap-2'>
            <img 
              src="https://firebasestorage.googleapis.com/v0/b/food-delivery-c504a.appspot.com/o/Images%2F1656562568863-i6.png?alt=media&token=298a9073-d275-408e-a807-626259145e71" 
              alt=""
